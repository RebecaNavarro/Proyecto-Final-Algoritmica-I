...
vector<pair<int, int>> grafo[100000] = {
    ...
    {{850, 1}, {INF, 2}, {260, 3}, {1300, 4}, {2500, 5}, {17300, 6}, {2500, 7}, {1700, 8}, {900, 9}, {1300, 10}, {13800, 11}, {2000, 12}, {1300, 13}, {1700, 14}, {200, 15}, {2600, 16}, {1300, 17}, {17600, 18}},
    {{850, 1}, {1000, 2}, {INF, 3}, {1100, 4}, {2200, 5}, {18300, 6}, {2200, 7}, {1700, 8}, {650, 9}, {1000, 10}, {12300, 11}, {1800, 12}, {800, 13}, {1700, 14}, {1500, 15}, {3100, 16}, {1000, 17}, {18600, 18}},
    {{900, 1}, {1600, 2}, {1600, 3}, {INF, 4}, {2600, 5}, {18900, 6}, {2700, 7}, {400, 8}, {1100, 9}, {1200, 10}, {14000, 11}, {1800, 12}, {1300, 13}, {550, 14}, {1700, 15}, {4200, 16}, {1200, 17}, {19200, 18}},
    {{2500, 1}, {2700, 2}, {2700, 3}, {2800, 4}, {INF, 5}, {16300, 6}, {30, 7}, {3000, 8}, {2800, 9}, {2500, 10}, {11400, 11}, {1300, 12}, {600, 13}, {1000, 14}, {1000, 15}, {3300, 16}, {600, 17}, {17500, 18}},
    {{1730, 1}, {17700, 2}, {17600, 3}, {17800, 4}, {16400, 5}, {INF, 6}, {16400, 7}, {17900, 8}, {17700, 9}, {17500, 10}, {12300, 11}, {17400, 12}, {17500, 13}, {17900, 14}, {17500, 15}, {15600, 16}, {17500, 17}, {9000, 18}},
    {{1800, 1}, {2500, 2}, {2700, 3}, {2900, 4}, {30, 5}, {16600, 6}, {INF, 7}, {2900, 8}, {2800, 9}, {1600, 10}, {11000, 11}, {1700, 12}, {1200, 13}, {700, 14}, {1600, 15}, {3200, 16}, {350, 17}, {18000, 18}},
    {{550, 1}, {1000, 2}, {900, 3}, {33, 4}, {2200, 5}, {18500, 6}, {2300, 7}, {INF, 8}, {650, 9}, {650, 10}, {13500, 11}, {1100, 12}, {350, 13}, {43, 14}, {1100, 15}, {3900, 16}, {700, 17}, {18600, 18}},
    {{1100, 1}, {900, 2}, {650, 3}, {1100, 4}, {2800, 5}, {18000, 6}, {2800, 7}, {950, 8}, {INF, 9}, {1400, 10}, {13000, 11}, {2300, 12}, {1100, 13}, {1500, 14}, {1300, 15}, {3200, 16}, {1400, 17}, {18000, 18}},
    {{82, 1}, {1000, 2}, {600, 3}, {600, 4}, {1600, 5}, {17200, 6}, {1600, 7}, {650, 8}, {900, 9}, {INF, 10}, {12400, 11}, {900, 12}, {300, 13}, {700, 14}, {850, 15}, {3100, 16}, {50, 17}, {17500, 18}},
    {{1200, 1}, {12000, 2}, {17000, 3}, {5500, 4}, {3000, 5}, {18000, 6}, {2800, 7}, {2800, 8}, {1500, 9}, {9000, 10}, {INF, 11}, {7500, 12}, {1100, 13}, {1300, 14}, {13000, 15}, {12000, 16}, {10000, 17}, {12000, 18}},
    {{1000, 1}, {1900, 2}, {2200, 3}, {1300, 4}, {1700, 5}, {17200, 6}, {1900, 7}, {1500, 8}, {2300, 9}, {900, 10}, {13000, 11}, {INF, 12}, {1500, 13}, {1400, 14}, {2000, 15}, {3100, 16}, {1000, 17}, {17500, 18}},
    {{270, 1}, {850, 2}, {600, 3}, {300, 4}, {2600, 5}, {17500, 6}, {2100, 7}, {350, 8}, {750, 9}, {300, 10}, {12400, 11}, {1700, 12}, {INF, 13}, {400, 14}, {850, 15}, {3300, 16}, {350, 17}, {17800, 18}},
    {{1000, 1}, {2000, 2}, {1700, 3}, {550, 4}, {3000, 5}, {1800, 6}, {3000, 7}, {150, 8}, {900, 9}, {750, 10}, {13400, 11}, {1400, 12}, {500, 13}, {INF, 14}, {2000, 15}, {3000, 16}, {700, 17}, {1800, 18}},
    {{1000, 1}, {200, 2}, {260, 3}, {2000, 4}, {2800, 5}, {1800, 6}, {2900, 7}, {1300, 8}, {800, 9}, {1200, 10}, {13000, 11}, {2100, 12}, {850, 13}, {1200, 14}, {INF, 15}, {2600, 16}, {1200, 17}, {1800, 18}},
    {{2900, 1}, {3300, 2}, {3400, 3}, {4000, 4}, {2600, 5}, {15000, 6}, {2300, 7}, {3600, 8}, {3200, 9}, {3100, 10}, {10400, 11}, {3500, 12}, {3100, 13}, {3600, 14}, {2600, 15}, {INF, 16}, {3200, 17}, {15200, 18}},
    {{600, 1}, {900, 2}, {600, 3}, {650, 4}, {1600, 5}, {17800, 6}, {1600, 7}, {700, 8}, {1000, 9}, {71, 10}, {13600, 11}, {900, 12}, {350, 13}, {800, 14}, {850, 15}, {3100, 16}, {INF, 17}, {18000, 18}},
    {{17500, 1}, {17800, 2}, {17800, 3}, {18700, 4}, {16500, 5}, {9200, 6}, {16500, 7}, {19000, 8}, {18700, 9}, {17600, 10}, {12400, 11}, {18300, 12}, {18400, 13}, {18000, 14}, {17600, 15}, {15600, 16}, {17600, 17}, {INF, 18}}};
